	...
	var cart = {
		'add': function(id_product, logged, product_name, image, url_product) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.message_error === ""){
                            addProductNotice('Ajouter Produit au chariot', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3><a href="' + url_product + '">"' + product_name + '"</a> ajouté au <a href="/e_commerce/cart">chariot</a>!</h3>', 'success');
            ...
            {
                addProductNotice('Ajouter produit au Chariot', '<img src="' + image + '" alt="">', '<h3>Vous devez <a href="/login/">Se Connecter</a> pour pouvoir sauvegarder <a href="' + url_product + '">"' + product_name + '"</a> dans votre <a href="/e_commerce/cart">Chariot</a>!</h3>', 'success');
            }
		},
		'remove':function(id_product, product_name, image, url_product) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.message_error === ""){
                        addProductNotice('Produit retiré de chariot', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3><a href="' + url_product + '">"' + product_name + '"</a> a été retiré de votre <a href="/e_commerce/cart">chariot </a>!</h3>', 'success');
	    ...
	    'add': function(id_product, logged, product_name, image, url_product) {
		    if(logged === "True") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.message_error === ""){
                            addProductNotice('Produit ajouter au souhaits', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3><a href="' + url_product + '">"' + product_name + '"</a> ajouté au <a href="/e_commerce/wish_list">liste des souhaits</a>!</h3>', 'success');
                            $("#number_in_wish_list").text("Wish List (" + data.number_products_in_wish_list + ")");
                        }
                        else
                        {
                            addProductNotice('Ajouter ' + product_name + ' au souhaits', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3>' + data.message_error + '</h3>', 'success');
                        }
                    }
                });
            }
            ...
            {
                addProductNotice('Ajouter produit au souhaits', '<img src="' + image + '" alt="">', '<h3>Vous devez <a href="/login/">Se Connecter</a> pour pouvoir sauvegarder <a href="' + url_product + '">"' + product_name + '"</a> au <a href="/e_commerce/wish_list">liste des souhaits</a>!</h3>', 'success');
            }
		}
	};
	var compare = {
	    'add': function(id_product, logged, product_name, image, url_product) {
		    if(logged === "True") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.message_error === ""){
                            addProductNotice('Ajouter produit à la Comparaison', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3><a href="' + url_product + '">"' + product_name + '"</a> ajouté à <a href="/e_commerce/compare">comparaison</a>!</h3>', 'success');
            ...
            {
                addProductNotice('Ajouter produit à comparaison', '<img src="' + image + '" alt="">', '<h3>Vous devez<a href="/login"> Se Connecter</a> pour pouvoir sauvegarder <a href="' + url_product + '">"' + product_name + '"</a> dans votre <a href="/e_commerce/wish_list"> liste de comparaison</a>!</h3>', 'success');
            }
		}
	};
